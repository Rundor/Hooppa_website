    ...
    <section id="dreamhouse" class="product-section active">
        <div class="product-overview">
            <div class="product-images-container">
                ...
                <img src="assets/images/electronicPiano1.jpg" alt="piano 1" class="active" />
                <img src="assets/images/electronicPiano2.jpg" alt="piano 2" class="active" />
                </div>
  ...
  <i id="desc-help-icon" class="fa fa-info-circle" style="cursor: pointer; margin-left: 8px;"></i>
    ...
    <section class="product-comments">
        ...
        <div class="comments-display">
            <p><strong>Lina:</strong>High Quality Instumental Toy.</p>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Show the side cart when clicking the cart icon
  if (cartIcon) {
  ...
  // Close the side cart when clicking the close button
  if (closeCart) {
  ...
  // Handle adding items to the cart (note: already handled by PHP on form submission)
  addToCartButtons.forEach(button => {
    button.addEventListener('click', () => {
      const productName = button.getAttribute('data-product');
      const productPrice = parseFloat(button.getAttribute('data-price'));
      const quantity = parseInt(document.getElementById('quantity-train').value);

      // This only updates the side-cart visually if using JS-only cart
      const cartItem = document.createElement('div');
      cartItem.classList.add('cart-item');
      cartItem.textContent = `${productName} x${quantity} - ${(productPrice * quantity).toFixed(2)} SAR`;
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  // Keep cart quantity fields in sync
