...
<?php endif; ?>
  ...
  <main class="product-page">
    <section id="Kite" class="product-section active">
        <div class="product-overview">
            <div class="product-images-container">
                <div class="product-images">
                <img src="assets/images/kite.png" alt="kite 1" class="active" />
                <img src="assets/images/kite2.png" alt="kite 2" class="active" />
                </div>
